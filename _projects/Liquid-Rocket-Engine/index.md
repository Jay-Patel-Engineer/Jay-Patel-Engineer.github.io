...
## Manufacturing
The manufacturing process primarily utilized a lathe; however, some parts were modified using a vertical mill. Before beginning manufacturing, a tolerance needed to be decided to improve machining feasibility. Due to the simple nature of most of the parts, tolerancing was determined using ISO 2768 as a guide. While the different parts need to be fitted together, they do not need to be perfect. The most crucial fit of the complete assembly is the seal created between the injector plate and the combustion chamber. However, this seal was later reinforced by a set of O-rings. The second most important tolerances are the ones that govern the diameter of the orifices located on the injector plate. These orifices control the flow rate of propellants and are sized to achieve the necessary flow rate for efficient combustion. A cylindricity tolerance was applied to these orifices.
{% include image-gallery.html images="nozzle_holder.png, nozzle_insert.png" height="400"%}
<span style="font-size: 15px">Nozzle Holder and Nozzle Insert</span>
{% include image-gallery.html images="assembled_chamber.png" height="400"%}
<span style="font-size: 15px">Assembled Thrust Chamber</span>
{% include image-gallery.html images="machined_injector.png" height="400"%}
<span style="font-size: 15px">Pintle Injector</span>
{% include image-gallery.html images="assembled_stand.png" height="400"%}
<span style="font-size: 15px">Assembled Thrust Stand</span>
## Testing
...
<span style="font-size: 15px">Oxidizer Cold Flow Testing</span>
{% include youtube-video.html id="0Mt1T-wTBKM" autoplay= "false"%}
<span style="font-size: 15px">Fuel Cold Flow Testing</span>
...
<span style="font-size: 15px">Thrust Chamber Hydrostatic Testing</span>
...
<span style="font-size: 15px">Test Fire 1</span>
{% include youtube-video.html id="xCFsjYxbUxk" autoplay= "false"%}
<span style="font-size: 15px">Test Fire 2</span>

<br>

---
The following sections contain in-depth analysis and demonstration of the design process for major components.
## CEA Analysis
...
<span style="font-size: 15px">Data Collected by CEARUN</span>
...
<span style="font-size: 15px">Internal View of Assembled Thrust Chamber</span>
### Combustion Chamber
...
<span style="font-size: 15px">CAD Design of Combustion Chamber</span>
### Injector Plate
...
<span style="font-size: 15px">Simulation Results via ANSYS</span>
## Thrust Stand
...
<span style="font-size: 15px">Final P&ID Including all Redundancy Valves</span>
{% include image-gallery.html images="PlumbingCAD.png" height="400"%}
<span style="font-size: 15px">Plumbing System Designed in CAD</span>
